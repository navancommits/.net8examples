...
namespace MiddlewareLifetimes.Middlewares
{
    ...
    public class Options1Middlware
    {
        ...
        private readonly IOptions<VoterOptions> options;

        /// <summary>
        /// Crea una nueva instancia de CustomMiddleware
        /// </summary>
        /// <param name="next">A function that can process an HTTP request.</param>
        public Options1Middlware(RequestDelegate next, ILogger<Options1Middlware> logger, IOptions<VoterOptions> options)
        {
            this._next = next;
            this.logger = logger;
        ...
        public async Task InvokeAsync(HttpContext context, IOptionsSnapshot<VoterOptions> optionsSnapshot)
        {
